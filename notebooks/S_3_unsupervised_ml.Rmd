...
library(magrittr) # For adittional pipe operators
...
![](media/super_unsuper2.png){width=750px}


### A functional perspective

![](media/super_unsuper.png){width=750px}
...
![](media/dim_tech.png){width=500px}
...
```{r,fig.align='center'}
data %<>% drop_na() # does not work with NAs. Could be imputed, though.
